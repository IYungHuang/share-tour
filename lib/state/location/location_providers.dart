...
class LocationNotifier extends Notifier<LocationControllerState> {
  ...
  Future<void> switchManifest(
    ...
    final spawn = newSpawnPixel ?? manifest.defaultSpawnPixel;
    _controller.switchLayer(manifest, newSpawnPixel: spawn);
    _virtual.switchManifest(manifest, newSpawnPixel: spawn);
